...
public class TelemetryManager
{
    ...
    public TelemetryManager(PacketManager packetManager)
    {
        ...
        //    protocolManager.SendCommandRequest += protocolManager.OnSendCanCommand; //per il momento forzo il can poi dovr� gestirlo coi canali attivi
    ...
    public void onAppLayerPacketReady(object sender, PacketReadyEventArgs e)
    {
        ...
        {
            //Cerca nella lista TelemetryDictionary se esiste un elemento il cui corridpondente numerico della stringa addrH e addrL � uguale al payload[2] e payload[3]
        ...
        {
            //Prosegui solo se il tipo di telemetria � zero
    ...
    public async Task TelemetryStart()
    {
        ...
        //Il comando di configurazione � cos� composto:
        //byte 0->3 Tipo telemetria HH Tipo telemetria HL Tipo telemetria LH	Tipo telemetria LL
        //Il tipo � un codice univoco deciso dall'amministratore tramite portale all'atto del configurare la telemetria e viene usato per la decodifica dei dati binari"		
        //byte 4->7 Indirizzo Destinazione HH Indirizzo Destinazione HL	Indirizzo Destinazione LH	Indirizzo Destinazione LL
        //Indirizzo del protocollo Stem a cui inviare i messaggi di telemetria (� il mio indirizzo myAddress)
        //byte 8 Istanza Telemetria: � il numero del task in cui faccio girare questa configurazione di telemetria	(normalemnte � 0)
        ...
        //(normalmente � l'indirizzo della scheda da cui prelevi,  ma potrebbe essere anche quello di un'altra)
        //byte 15->16
        //Indirizzo Logico Data1 H Indirizzo Logico Data1 L
        // �	
        //Indirizzo Logico Data16 H Indirizzo Logico Data16 L
        //(Il numero di variabili � dinamico e al massimo vale SP_TEL_N_VARS che viene configurato nel firmware. Normalmente vale 16)
    ...
    public async Task TelemetryWriteTaskOneShot()
    {
        while (TelemetryOn == true)
        {
            ...
            //e poi c'� il valore della variabile con la dimensione ricavata dal dizionario stem
            ...
            // Se l'architettura � little-endian, inverti l�ordine per ottenere big-endian
